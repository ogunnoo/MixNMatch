...
class BACKGROUND_STAGE(nn.Module):
    def __init__(self, ngf):
        ...
        # 64*64*64
        """Removed self.upsample5 and changed the output filter of self.upsample4 from 128 to 64"""
    ...
    def forward(self, z_input, input):
        ...
        """Removed self.upsample5(out_code)"""
...
class G_NET(nn.Module):
    def __init__(self):
        ...
        """Changed the size from 126 to 62 to reflect the change of size from 128 to 64"""
